...
const Todo = ({ val, onDelete }) => {
  ...
  return (
    <>
      <div>
        <div className="bg-blue-500 transition delay-2 duration-100 ease-in-out hover:-translate-y-1   hover:scale-101  hover:bg-cyan-800 :hover text-white w-auto h-12 font-bold font-mono mt-1 flex flex-row justify-between items-center pr-10 pl-1.5 max-sm:h-10 ">
          {val}
